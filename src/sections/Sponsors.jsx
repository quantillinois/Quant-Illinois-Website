  ...
  return (
    <div className="h-auto py-8">
      ...
      <div className="bg-sky-100 py-10 mx-5 lg:mx-20 rounded-lg">
        <h2 className="text-left text-3xl font-medium text-sky-700 pl-10">Platinum</h2>
      ...
      <div className="bg-orange-200 py-10 mx-5 lg:mx-20 mt-10 rounded-lg">
        <h2 className="text-left text-3xl font-medium text-orange-700 pl-10">Gold</h2>
        <div className="flex justify-center py-10">
      ...
      <div className="bg-zinc-300 py-10 mx-5 lg:mx-20 mt-10 rounded-lg">
        <h2 className="text-left text-3xl font-medium text-zinc-700 pl-10">Silver</h2>
        <div className="grid grid-rows-2 grid-cols-3 lg:grid-cols-5 lg:grid-rows-1 justify-center gap-5 lg:gap-10 px-10 lg:px-24 py-10">
