...
export default function Overview() {
  return (
    <div className="relative min-h-screen bg-gradient-to-tr from-[#48d1cc] to-blue-600 grid grid-cols-5 w-full py-20">
      <div className="text-center col-span-5 lg:col-span-2">
        ...
        <img src={infonight} alt="SCD" className="w-[80%] mx-auto mt-5 hidden lg:block"/>
      </div>
